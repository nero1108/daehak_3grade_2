...
public class BookDao {
	...
	public boolean isISBN(String b_isbn) {
	      ...
	      System.out.printf("[BookDao]에서 result=%d\n", result);
	...
	public List<BookVo> selectBooksBySearch(BookVo bookVo) {
	      System.out.println("[BookDao] selectBooksBySearch(BookVo bookVo)");
	      
	      String sql =  "SELECT * FROM tbl_book " + "WHERE b_no LIKE ? " + "ORDER BY b_no DESC";
