...
public class BookController {
	...
	//   @RequestMapping(value = "/searchBookConfirm", method = RequestMethod.GET)
	   ...
	   public String searchBookConfirm(BookVo bookVo, Model model) {
	      ...
	      String nextPage = "admin/book/sujung_book";
	...
	//   @RequestMapping(value = "/modifyBookForm", method = RequestMethod.GET)
	   ...
	   public String modifyBookForm(@RequestParam("b_no") int b_no, Model model, HttpSession session) {
	      ...
	      if (loginedAdminMemberVo == null)
	         //return "redirect:/admin/member//loginForm"; //원래 코드
	...
	//   @RequestMapping(value = "/modifyBookConfirm", method = RequestMethod.POST)
	   ...
	   public String modifyBookConfirm(@RequestParam("b_no") int b_no, BookVo bookVo, @RequestParam("file") MultipartFile file,  HttpSession session, Model model) {
	      ...
	      bookVo = bookService.bookDetail(b_no);
